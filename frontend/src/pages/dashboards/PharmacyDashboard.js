 ...
 * ─────────────────────────────────────────────────────────
 * PLACEHOLDER — Route: /pharmacy  (Pharmacy role only)
 * ─────────────────────────────────────────────────────────
 * Pharmacy teammate: replace this file's body with the
  ...
  return (
    <div style={page}>
      <div style={card}>
        ...
        <p style={note}>📌 Placeholder — Pharmacy teammate: implement here.</p>
      </div>
    </div>
  );
}
...
const note = { background:"#e3f2fd", border:"1px dashed #42a5f5", borderRadius:"8px", padding:"8px 14px", fontSize:"13px", color:"#0d47a1" };
